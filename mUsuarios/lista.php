        ...
        while( $row = mysqli_fetch_array($consultar) ) {
           ...
           ?>
            ...
            <tr class="centrar">
                ...
                <td>
                    <button <?php echo $dtnDesabilita?> type="button" class="PermisosUs btn btn-outline-danger btn-sm activo"  id="btnPermisosUs<?php echo $varGral?><?php echo $n?>" onclick="abrirModalPermisos_Us('<?php echo $id?>','<?php echo $user_name?>','<?php echo $checkDp?>','<?php echo $checkEc?>','<?php echo $checkUs?>','<?php echo $checkTm?>')">
