  ...
  <div class="modal-dialog modal-lg" role="document" >
    <div class="modal-content">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="form-group">
                  ...
                  <ul>
                    <label class="rojo"  id="Sim">8 o mas caracteres</label><label class="" id="aceptado"></label><br>
                   <label class="rojo" id="Lon">Las contraseñas deben coincidir</label> <label class="" id="rechazado"></label>
                  </ul>
              </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal" id="CanPass" onclick="LimpiarModalCambioPass()">Cerrar</button>
        ...
        <button id="btnGuardarPass" type="button" class="btn btn-danger" onclick="cambiarPass()" disabled><i class="far fa-save"></i> Guardar Contraseña</button>
      </div>
    </div>
  </div>
</div>